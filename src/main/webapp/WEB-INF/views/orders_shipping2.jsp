...
<html lang="en">
   ...
   <body>
      ...
      <div class="container-fluid">
         ...
         <div class="container">
            <h1 class="page-title">
               <i class="fas fa-cog"></i> <fmt:message key="setting"/>
            </h1>
               ...
               <div class="content-area">
                  ...
                  <section class="section" id="orders">
                     <h3 class="section-title">
                        <i class="fas fa-user-circle"></i> <fmt:message key="orders.title"/>
                     </h3>
                     ...
                     <c:if test="${ empty requestScope.orders }">
                        <div class="text-danger text-center">
                           <fmt:message key="orders.empty.shipping"/>
                        </div>
                     </c:if>
                                 ...
                                 <div class="d-flex flex-row">
                                    ...
                                    <div class="d-flex flex-column">
                                       ...
                                       <div class="overflow-x-hidden">
                                          ...
                                          ${ord.address.fullAddress}, ${ord.address.ward}, ${ord.address.city}, ${ord.address.country}
                                       </div>
                                    </div>
                                 </div>
                              </div>
