                    ...
                    <section class="section" id="security">
                        ...
                        <form class="form-grid" action="${ctx }/login/changePass" method="POST">
                            <div class="form-group full-width">
                                ...
                                <input type="password" id="current-password" placeholder="<fmt:message key="ser.enter_cur"/>" name="currPass">
                            </div>
                            ...
                            <ul class="activity-list">
                                <li class="activity-item">
                                    ...
                                    <div class="activity-info">
                                        ...
                                        <span><fmt:message key="ser.2g"/></span>
                                    </div>
                                </li>
                                <li class="activity-item">
                                    <div class="activity-icon">
                                    ...
                                    <div class="activity-info">
                                        ...
                                        <span><fmt:message key="ser.yes"/></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
