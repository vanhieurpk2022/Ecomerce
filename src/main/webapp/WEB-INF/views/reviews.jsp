                     ...
                     <c:forEach var="od" items="${requestScope.od }">
                        ...
                        <div class="shadow p-3 border rounded-3 mb-3">
                           ...
                           <div class="d-flex flex-column flex-md-row justify-content-end align-items-start align-items-md-center mb-2">
                              <a href="${pageContext.request.contextPath}/product/detail?pid=${od.productID }&cid=${od.product.category.categoryID}"
                                 class="btn btn-info text-light mt-2 mt-md-0 me-2">
                                 <fmt:message key="btn.buy"/>
                              </a>

                              <button class="btn btn-warning text-light mt-2 mt-md-0 ${od.isRated ? 'disabled' : ''}"
                                      data-bs-toggle="modal"
                                      data-bs-target="#exampleModal-${od.orderDetailID }">
                                 ...
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                       <h5 class="modal-title">
                                          <fmt:message key="rating.modal.title"/>
                                       </h5>
                                    ...
                                    <div class="modal-body">
                                       <div class="text-center">
                                          ...
                                          <p id="ratingText-${od.orderDetailID}" class="fw-semibold rating-text">
                                             <fmt:message key="rating.notRated"/>
                                          </p>
                                       </div>
                                    ...
                                    <div class="modal-footer">
                                       <button class="btn btn-primary btn-submit-review"
                                               ...
                                               data-odid="${od.orderDetailID}"
                                               data-pid="${od.productID}">
                                          <fmt:message key="rating.submit"/>
                                       </button>
                                    </div>
