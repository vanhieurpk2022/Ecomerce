    ...
    <section id="signup">
        <form action="${ctx}/login/login" method="POST">
            <div class="signup_Header">
                <h1><fmt:message key="auth.brand"/></h1>
                <h2><fmt:message key="auth.signin.title"/></h2>
            </div>
            ...
            <div class="forgot">
                <label for="remember" class="remember">
                    <input type="checkbox"
                           id="remember"
                           name="checkbox_re"
                           ${not empty AccountCookies.remember ? 'checked' : ''}>
                    <span><fmt:message key="auth.remember"/></span>
                </label>

                <div>
                    <a href="${ctx}/login/forgot"><fmt:message key="auth.forgot"/></a>
                </div>
            </div>
            ...
            <p>
                <fmt:message key="auth.noAccount"/>
                <a href="${ctx}/login/signup"><fmt:message key="auth.signup.link"/></a>
            </p>
        </form>
    </section>
