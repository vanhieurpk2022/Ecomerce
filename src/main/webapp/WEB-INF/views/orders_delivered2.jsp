                  ...
                  <section class="section" id="orders">
                        ...
                        <div class="row g-3 mb-4 ms-auto justify-content-end">
                           <div class="col-md-4">
                              <select class="form-control" name="search">
                                 <option value="all" ${requestScope.choose == 'all' ? 'selected' : ''}>
                                    <fmt:message key="orders.filter.all"/>
                                 </option>
                                 <option value="today" ${requestScope.choose == 'today' ? 'selected' : ''}>
                                    <fmt:message key="orders.filter.today"/>
                                 </option>
                                 <option value="week" ${requestScope.choose == 'week' ? 'selected' : ''}>
                                    <fmt:message key="orders.filter.week"/>
                                 </option>
                                 <option value="month" ${requestScope.choose == 'month' ? 'selected' : ''}>
                                    <fmt:message key="orders.filter.month"/>
                                 </option>
                              </select>
                           </div>
                     ...
                     <c:if test="${ empty requestScope.orders }">
                        <div class="text-danger text-center">
                           <fmt:message key="orders.empty.delivered"/>
                        </div>
                     </c:if>
                     ...
                     <div class="overflow-y-scroll" style="max-height: 1000px;">
                        <c:forEach var="ord" items="${requestScope.orders}">
                           ...
                           <div class="shadow p-3 border rounded-3 mb-3">
                              <!-- Order Header -->
                              <div class="d-flex flex-column justify-content-between align-items-start align-items-md-center mb-2">
                                 <div class="w-100 d-flex justify-content-between align-items-start align-items-md-center">
                                    <div>
                                 ...
                                 <p class="fw-semibold m-0">
                                    <fmt:message key="orders.info"/>
                                 </p>

                                 <div class="d-flex mb-3 flex-column shadow-sm rounded-2 p-3 w-100">
                                    <div class="d-flex flex-row">
                                       <div class="mt-2 d-none d-sm-flex">
                                          <i class="bi bi-geo-alt fs-4 px-3"></i>
                                       </div>
                                       ...
                                       <div class="d-flex flex-column w-100">
                                          <div class="d-flex flex-row p-1 mt-2 position-relative">
                                             <strong class="me-2"><fmt:message key="label.fullName"/>:</strong>
                                             ${sessionScope.user.firstname} ${sessionScope.user.lastname}

                                             <span class="opacity-50 fw-semibold small position-absolute top-0 start-100 ms-2">
                                                <fmt:message key="label.phone"/>: ${ord.address.phone}
                                             </span>
                                          </div>

                                          <div class="overflow-x-hidden">
                                             <strong class="me-2"><fmt:message key="label.address"/>:</strong>
                                 ...
                                 <p class="fw-semibold m-0">
                                    <fmt:message key="orders.products"/>
                                 </p>
                                    ...
                                    <div class="d-flex align-items-center mb-3 Small shadow-sm rounded-2 p-3">
                                       ...
                                       <div class="flex-grow-1 px-3 position-relative">
                                          ...
                                          <div class="small text-muted">
                                             <fmt:message key="label.quantity"/>: ${od.quantity}
                                          </div>

                                          <div class="d-md-none mt-1">
                                             <span class="fw-bold">
                                                <fmt:formatNumber value="${od.price}" pattern="#,##0 VNĐ"/>
                                             </span>
                                          </div>
                                 ...
                                 <div class="d-flex mb-3 flex-column shadow-sm rounded-2 p-3 w-100">
                                    <p class="fw-semibold m-0">
                                       <i class="bi bi-journal-minus"></i> <fmt:message key="orders.note"/>
                                    </p>
                                 ...
                                 <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center w-100">
                                    <div class="d-flex flex-column">
                                       <div>
                                          ...
                                          <span class="fs-4 text-danger">
                                             <fmt:formatNumber value="${ord.totalAmount}" pattern="#,##0 VNĐ"/>
                                          </span>
                                       </div>
                                       <div class="small">
                                    ...
                                    <button onclick="cancelOrder('${ord.orderID}','${ctx}')"
                                            class="btn btn-danger mt-2 mt-md-0 ${ (ord.status == 'SUCCESS' || ord.status == 'SHIPPING') ? 'disabled' : '' }">
