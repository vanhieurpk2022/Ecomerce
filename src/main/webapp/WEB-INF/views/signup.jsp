    ...
    <section id="signup">
        <form id="register" action="${ctx}/login/register" method="POST">
            ...
            <div class="signup_Main">
                ...
                <input type="text" placeholder="${phEmail}" id="email_signup" required name="email" value="${email}">

                <div class="verify">
                    <button type="button" id="btn_verify" onclick="sendData();">
                        <fmt:message key="auth.verify.send"/>
                    </button>
            ...
            <label>
                ...
                <fmt:message key="auth.terms.prefix"/>
                <a href="#"><fmt:message key="auth.terms.tos"/></a>
                <fmt:message key="auth.terms.and"/>
                <a href="#"><fmt:message key="auth.terms.privacy"/></a>
            </label>

            <button id="signup_btn" type="submit">
                <fmt:message key="auth.signup.btn"/>
            </button>

            <hr>

            <p>
                <fmt:message key="auth.haveAccount"/>
