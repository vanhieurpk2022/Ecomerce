               ...
               <div class="content-area">
                  <section class="section" id="orders">
                     <h2 class="section-title">
                        <i class="fas fa-box"></i> <fmt:message key="orders.title"/>
                     </h2>
                           ...
                           <div class="shadow p-3 border rounded-3 mb-3">
                              ...
                              <c:forEach var="od" items="${ord.orderDetail}">
                                 <div class="d-flex align-items-center mb-3 Small shadow-sm rounded-2 p-3">
                                    <img src="${od.product.img}" class="me-3 rounded" width="80" alt="Product">
                                    <div class="flex-grow-1">
                                       ...
                                       <span class="fw-bold">
                                          x <fmt:formatNumber value="${od.price }" pattern="#,##0 VNĐ"/>
                                       </span>
                                    </div>
                                 </div>
                              </c:forEach>
